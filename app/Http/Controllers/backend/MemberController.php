...
class MemberController extends Controller
{
    ...
    public function membersAll()
    {
        ...
        return view('backend.members.member-all');
    }
    ...
    public function serverside(Request $request)
    {
        ...
        $order = 'created_at';
        $dir = 'desc';
        $members = Member::where('member_status', '=', '1')->whereNotNull('member_Bday')->offset($start);
        ...
        if(!empty($members))
        {
            ...
            foreach ($members as $member)
            {
                ...
                $icon = "<i class='fa fa-user-times' aria-hidden='true' style='margin-right: 5px'></i>";
                ...
                $nestedData['options'] = '
                        ...
                        <button class="btn btn-primary"><i class="fa fa-eye" aria-hidden="true" style="margin-right: 5px"></i>
                        </i>ดูข้อมูล</button>
                    </a>
                    '.$online_status.'
                    <button
                    class="btn btn-danger" onclick="return confirm(`'.$member->_id.'`);">
                    '.$icon.'ลบ</button>';
    ...
    public function on_line($id)
    {
      ...
      //                 ->with('success','ลบผู้สอนเรียบร้อย');
      $text = [
        'success' => "ออฟไลน์สมาชิกเรียบร้อย"
      ];
