...
class CourseController extends Controller
{
    ...
    public function store(Request $request){
        ...
        // dd($request->select_student_level,json_decode($request->student_detail));
        $course_student = [];
        if(($request->course_category == "Private") || ($request->course_category == "School")){
          ...
          if ($request->course_category == "School") {
            ...
            foreach (json_decode($request->student_detail) as $key => $value) {
        ...
        // dd($course_student,$request->select_student_level,json_decode($request->student_detail));
        $data = ([
