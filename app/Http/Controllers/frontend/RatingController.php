      ...
      if($student_rating){
         for($i=1; $i<=count($request->student_id); $i++) { 
            ...
            for($j=1; $j<=count($request->rating_id); $j++) {
               ...
               if(isset($request->rating_1) && !isset($request->rating_m_1)){
                  $rating_name = 'rating_'.$j;
                  $recomment_name = 'recommend_web';
               }
               else if(!isset($request->rating_1) && isset($request->rating_m_1)){
                  $rating_name = 'rating_m_'.$j;
                  $recomment_name = 'recommend_mobile';
               }
               else{
                  $rating_name = 'rating_'.$j;
                  $recomment_name = isset($request->recommend_web)?'recommend_web':'recommend_mobile';
               }
            ...
            $save_student_rating->recommend = $request->$recomment_name;
