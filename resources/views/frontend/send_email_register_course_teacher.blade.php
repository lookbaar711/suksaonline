...
<div class="row">
    ...
    <div style="padding-bottom: 15px; font-size: 14px;">
        ...
        <label style="font-size: 16px;">สมัครเรียนสำเร็จ</label><br><br>
        <label>คุณ {{ $student_fullname }} สมัครเรียนคอร์ส {{ $course_name }}</label><br>
        <label>วันที่นัด {{ $course_date }} เวลา {{ $course_time_start }} - {{ $course_time_end }} น.</label><br><br>       
