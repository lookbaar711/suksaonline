                            ...
                            <div class="row" >
                                <div class="col-sm-3 col-sm-offset-3">
                                    <div class="form-group label-floating">
                                        ...
                                        <input type="text" name="member_fname" id="member_fname" class="form-control firstname" required autocomplete="none" onChange="checkfullname()"  onkeyup="checkTextOnly(this.id)">
                                ...
                                <div class="col-sm-3 ">
                                    <div class="form-group label-floating">
                                        ...
                                        <input type="text" name="member_lname" id="member_lname" class="form-control lastname" required autocomplete="none" onChange="checkfullname()" onkeyup="checkTextOnly(this.id)">
                                ...
                                <div class="col-sm-6 col-sm-offset-3">
                                    <div class="form-group label-floating">
                                        ...
                                        <input type="text" name="member_tell" id="member_tell" minlength="10" maxlength="10" class="form-control phonenumber" required autocomplete="none" onkeyup="checkNumberOnly(this.id)">
...
<script language="javascript">
    ...
    @if(session('create_user_error')=='fales')
    var error_name_sum = '{{ trans('frontend/users/modal.error_name_sum') }}';
        Swal.fire({
            title: '<strong>'+error_name_sum+'</u></strong>',
            type: 'error',
