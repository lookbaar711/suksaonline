                                ...
                                <div class="col-sm-6">
                                    <div class="col-sm-6" >
                                        <div class="form-group label-floating">
                                            ...
                                            <div id="checkname" datacheck="0"></div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                     <div class="form-group label-floating">
                                        ...
                                        <input type="text" name="member_tell" id="member_tell" minlength="10"  maxlength="10" required class="form-control" autocomplete="none" onkeyup="checkNumberOnly(this.id)">
