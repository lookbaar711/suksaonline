                              ...
                              <div class="tab-content">
                                  ...
                                  <div class="tab-pane active" id="tab1">
                                      ...
                                      <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                          <div class="form-group row">
                                             <label for="inputPassword" class="col-form-label">@lang('frontend/members/title.school')</label>
                                             <div class="col-sm-11">
                                      ...
                                      <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                          <div class="form-group row">
                                             <label for="inputPassword" class=" col-form-label">@lang('frontend/members/title.faculty')</label>
                                             <div class="col-sm-10">
                                        ...
                                        <div class="col-sm-6">
                                          <div class="form-group row">
                                             <label for="inputPassword" class=" col-form-label">@lang('frontend/members/title.university')</label>
                                             <div class="col-sm-10">
                                      ...
                                      {{-- โรงเรียนที่สอนอยู่ปัจจุบัน --}}
                                      <div class="alert alert-secondary" role="alert">
                                        @lang('frontend/members/title.school_name_teacher')
                                      </div>
                                          ...
                                          <div class="col-sm-12">
                                              <div id="myRepeatingFields2">
                                                  <div class="entry col-xs-12">
                                                      <div class="container">
                                                          <div class="row">
                                                            <label class="col-12 col-form-label">@lang('frontend/members/title.school_name') : </label>
                                                            <div class="school col-md-12"></div>
                                                          </div>
                                                      </div>
                                                  </div>
                                              </div>
