...
@endphp
<div class="modal fade bd-example-modal-lg modal_request_2" id="modal_request_2" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <div class="col-sm-12 col-md-4 text-center ">
            ...
            <button type="button" id="confirm_request_2" onclick="request.confirm_request()" style="color: white; font-size: 15px;" class="btn btn-light flex-c-m bo-rad-23  bgwhite hov1 trans-0-4 color7">@lang('frontend/members/title.confirm_create_request')</button>
        </div>
        <div class="col-md-4"></div>
      </div>
    </div>
