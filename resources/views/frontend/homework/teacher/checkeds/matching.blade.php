...
<section class="p-t-50 p-b-30">
    <div class="container">
        ...
        <div align="center" style="margin-top : 30px; margin-bottom : 30px;">
            ...
            <br>
            <h3>@lang('frontend/homework/title.checkedhomework'){{trans('frontend/homework/title.matching')}}</h3>
        </div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">{{trans('frontend/homework/title.matching')}}</li>
            </ol>
        </nav>
        <hr>
                                ...
                                <div class="col-sm-5">
                                    <div class="col-sm-12">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-10 choice-question"> {!!$item['choice']!!}  <div class="question_score">{{ "(".$item['question_score']." ".trans('frontend/homework/title.score').")" }}</div></div>
                                        </div>
                                    </div>
                                </div>
