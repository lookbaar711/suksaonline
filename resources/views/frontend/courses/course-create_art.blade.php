          ...
          {{ csrf_field() }}
           ...
           <div class="col-sm-10 p-l-0" id="sub5" style="display: none;">
             <div id="myRepeatingFields6">
              <label class="col-md control-label p-l-0">@lang('frontend/courses/title.specify_email') : <span style="color: red; font-size: 20px;" >*</span></label>
              <div class="entry">
                <div class="form-row" >
           ...
           <div class="form-row">
              <div class="form-row col-sm-12" id="sub7">
                ...
                <div class="form-group col-sm-3"id="div1" style="margin-top: -10px;">
                  ...
                  <input type="hidden" id="member_school" value="{{ $school_detail['school_id'] }}" />
                </div>
              </div>
           ...
           <div class="form-row" id="sub3" style="display: none;">
              ...
              <hr>
              <div class="col-md-12">
                <label class="col-md control-label p-l-0">@lang('frontend/courses/title.pretest') : <span style="color: red; font-size: 20px;" >*</span></label>
              </div>
              @for ($i=0; $i < 10; $i++)
                @php
                  $y = 0;
                ...
                <div class="form-group row ">
                 ...
                 <div class="col-md-11">
                   <input type="text" name="question_{{ $i+1 }}" id="question_{{ $i+1 }}" class="form-control question" autocomplete="off" placeholder="@lang('frontend/courses/title.question') {{ $i+1 }}" value="" required>
                 </div>
               </div>
               <div class="form-group row ">
    ...
    $(function() {
      ...
      var remove_button6 = '{{ trans('frontend/courses/title.remove_button') }}';
        ...
        $(document).on('click', '.btn-add6', function(e) {
            ...
            //console.log(email);
            const result = email.find(fruit => fruit.member_email.toLowerCase() === txt11.toLowerCase());
            //console.log(result);
