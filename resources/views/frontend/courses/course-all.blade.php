...
<section class="p-t-50 p-b-65">
    <div class="container">
        ...
        <div align="center" style="margin-top : 30px;"><i class="fa fa-graduation-cap hat fa-3x" style="color: aquamarine;"></i><br><h3>@lang('frontend/courses/title.course_online')</h3></div>
