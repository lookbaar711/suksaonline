...
<div class="modal fade bd-example-modal-lg modal_request" id="modal_request" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <label>@lang('frontend/members/title.how_long') :</label>
          ...
          <input type="text" class="form-control" id="lang_reques_time" value="@lang('frontend/layouts/title.please_select')" name="lang_reques_time" style="display:none;">
          {{-- <form> --}}
      ...
      <div class="modal-footer">
        ...
        <div class="col-sm-12 col-md-4 text-center">
            <button type="button" id="confirm_request" onclick="request.make_data_request()" style="color: white; border: 1px; font-size: 15px;" class="btn flex-c-m size2 bo-rad-23">@lang('frontend/members/title.create_button')</button>
        </div>
        <div class="col-md-4"></div>
      </div>
    </div>
