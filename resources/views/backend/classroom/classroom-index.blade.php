...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="#"> จัดการห้องเรียน</a></li>
        <li class="active">จัดการห้องเรียน</li>
    </ol>
</section>
                        ...
                        <table class="table table-bordered" id="table">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 120px;">ชื่อคอร์ส</th>
                                    <th>ชื่ออาจารย์</th>
                                        ...
                                        <td align="center">
                                          @if($item->classroom_status == 0)
                                            @if (date('Y-m-d H:i', strtotime($item->classroom_date." ".$item->classroom_time_end)) < date("Y-m-d H:i"))
                                              ...
                                              <button class="btn btn-secondary" disabled>Copy Link</button>
                                            @else
                                          ...
                                          @elseif($item->classroom_status == 1)
                                            ...
                                            @else
                                              <button class="btn btn-success openClassRoom" data-classroom_id="{!! $item->course_id !!}">เปิด</button>
                                              <button class="btn btn-success" onclick="copyLink('{!! $url[$item->course_id] !!}')">Copy Link</button>
                                            @endif
                                          @else
                                            <button class="btn btn-secondary" disabled>เปิด</button>
                                            <button class="btn btn-secondary" disabled>Copy URL</button>
                                          @endif
...
<script type="text/javascript" src="{{ asset('assets/vendors/datatables/js/dataTables.bootstrap.js') }}" ></script>
    ...
    <div class="modal fade" id="open_class_room_confirm" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    คุณต้องการเปิดห้องสอนนี้ใช่หรือไม่ ?
                </div>
                <div class="modal-footer">
    ...
    <script>
        ...
        function copyLink(url) {
            ...
            Swal.fire({
                title: '<strong>Copy link success</u></strong>',
                type: 'success',
                imageHeight: 100,
...
<script type="text/javascript">
    @if(session('bbb_status')=='เปิดห้องสอนนี้เรียบร้อยแล้ว')
        Swal.fire({
