        ...
        <div class="col-lg-12">
            <div class="panel panel-primary ">
                ...
                <div class="panel-body">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="box-form">
                                                <label for="title" class="ccontrol-label">
                                                    เเบบฟอร์มตัวอย่างการนำเข้าข้อมูลนักเรียน
                                                </label>
                                                <div class="box-donwload">
                                                    <a href="{{url('backend/school/donwload/student')}}"  class="btn btn-donwload"><i class="fa fa-download" aria-hidden="true"></i>  ดาวน์โหลดแบบฟอร์ม</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <form class="form-horizontal" role="form" method="post" action="{{ route('school.import.student.store') }}" enctype="multipart/form-data">
                        <!-- CSRF Token -->
                        ...
                        <div class="form-group {{ $errors->
                            first('file_student', 'has-error') }}">
                            <label for="title" class="col-sm-2 control-label">
                                ไพล์
                                <span style="color: red; font-size: 15px;">* รองรับเฉพาะ .xlsx,xls</span>
                            </label>
                            <div class="col-sm-5">
                                <input type="file" class="form-control" name="file_student" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel" required>

                            </div>
                            <div class="col-sm-4">
                                {!! $errors->first('file_student', '<span class="help-block">:message</span> ') !!}
                            </div>
                        </div>
