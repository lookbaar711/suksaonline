...
Route::get('/get_member_all', 'frontend\MemberController@get_member');
...
Route::get('/CheckInClassFifteenQueue','backend\ClassroomController@CheckInClassFifteenQueue');
Route::get('/CheckInClassFifteen','backend\ClassroomController@CheckInClassFifteen');
Route::get('/CheckInClassFortyfiveQueue','backend\ClassroomController@CheckInClassFortyfiveQueue');
Route::get('/CheckInClassFortyfive','backend\ClassroomController@CheckInClassFortyfive');
Route::get('/CheckInClassSixtyQueue','backend\ClassroomController@CheckInClassSixtyQueue');
Route::get('/CheckInClassSixty','backend\ClassroomController@CheckInClassSixty');
Route::get('/CheckInClassThirtyQueue','backend\ClassroomController@CheckInClassThirtyQueue');
Route::get('/CheckInClassThirty','backend\ClassroomController@CheckInClassThirty');

//Frontend index
Route::group(['middleware' => ['SessionTimeout']], function () {
    Route::get('/', 'MainController@getFrontend');
    Route::get('/updatemember', 'frontend\UserController@updatemember');
});

Route::get('classroom/check/{noti_id}', 'frontend\ClassroomController@check')->name('classroom.check');
//Frontend after login
Route::group(['namespace'=>'frontend','middleware' => ['frontend','SessionTimeout']], function () {
    ...
    Route::group([ 'prefix' => 'courses'], function () {
        ...
        Route::post('/uploadImage', 'CourseController@uploadImage')->name('courses.uploadImage');
        ...
        Route::get('report/{course_id?}', 'ReportController@index');
    ...
    Route::group([ 'prefix' => 'examination'], function () {
        Route::get('/pretest/{course_id?}', 'ExaminationController@pretest');
        Route::post('/postpretest', 'ExaminationController@postpretest')->name('examination.pretest');
        Route::post('/postposttest', 'ExaminationController@postposttest')->name('examination.posttest');
        Route::get('/posttest/{course_id?}', 'ExaminationController@posttest');
        Route::post('/checktimeclass', 'ExaminationController@checktimeclass');
        // Route::post('/checkurlclass', 'ExaminationController@checkurlclass');
    });
    //homework
    Route::group([ 'prefix' => 'assignment','middleware' => ['LanguageSwitcher']], function () {
        Route::post('/searach', 'BuildHomeworkController@searachassignment');
        Route::get('/list/{assignment_id}', 'BuildHomeworkController@assignmentlist');
        Route::get('/assay/{assignment_id}/{question_id}', 'BuildHomeworkController@assignmenassay');

    });


    Route::group([ 'prefix' => 'homework','middleware' => ['LanguageSwitcher']], function () {
        Route::get('/list', 'BuildHomeworkController@index')->name('homework.list');
        Route::post('/searach', 'BuildHomeworkController@searachteacher');
        Route::get('/ConjobSendNotiTeacher', 'BuildHomeworkController@ConjobSendNotiTeacher');
        Route::get('/ConjobSendNotiTeacherq', 'BuildHomeworkController@ConjobSendNotiTeacherq');
        Route::get('/ConjobSendNotiStudent', 'BuildHomeworkController@ConjobSendNotiStudent');
        Route::get('/ConjobUpdateStatus', 'BuildHomeworkController@ConjobUpdateStatus');
        Route::match(['get', 'post'],'/teacher', 'BuildHomeworkController@teacher');
        Route::get('/teacher/manage/{assignment_id}', 'BuildHomeworkController@teachermanage');
        Route::get('/teacher/assignment/del/{assignment_id}', 'BuildHomeworkController@teacherdel');
        Route::get('/teacher/from_create', 'BuildHomeworkController@from')->name('homework.from_create');
        Route::get('/teacher/assignment/{assignment_id}', 'BuildHomeworkController@teacherlist');
        Route::get('/checked/{assignment_id}/{student_id}/{questions_id}', 'BuildHomeworkController@checkedquestion');
        Route::match(['get', 'post'],'/assignment', 'BuildHomeworkController@assignment');
        Route::post('/savechoice', 'BuildHomeworkController@savechoice')->name('homework.storechoice');
        Route::post('/savematching', 'BuildHomeworkController@savematching')->name('homework.storematching');
        Route::post('/saveshotanswer', 'BuildHomeworkController@saveshotanswer')->name('homework.storeshotanswer');
        Route::post('/savelonganswer', 'BuildHomeworkController@savelonganswer')->name('homework.storelonganswer');
        Route::post('/teachercheck', 'BuildHomeworkController@teachercheck')->name('homework.teachercheck');
        Route::get('/make/{assignment_id}', 'BuildHomeworkController@make');
        Route::get('/export/{assignment_id}', 'BuildHomeworkController@export');

        Route::get('/create/create_multiplechoice/{question_id}', 'BuildHomeworkController@create_multiplechoice')->name('homework.create_multiplechoice');
        Route::get('/create/create_multiplechoice/{assignment_id}/{question_id?}', 'BuildHomeworkController@edit_multiplechoice');
        Route::post('/save/create/multiplechoice', 'BuildHomeworkController@save_create_multiplechoice')->name('homework.teacher.create.multiplechoice');
        Route::post('/save/edit/multiplechoice', 'BuildHomeworkController@save_edit_multiplechoice')->name('homework.teacher.edit.multiplechoice');

        Route::get('/create/create_matching/{assignment_id}/{question_id?}', 'BuildHomeworkController@create_matching');
        Route::get('/create/create_shotanswer/{assignment_id}/{question_id?}', 'BuildHomeworkController@create_shotanswer');
        Route::post('/upload/Up_multiplechoice', 'BuildHomeworkController@Up_multiplechoice');
        Route::get('/create/create_shotanswer', 'BuildHomeworkController@create_shotanswer')->name('homework.create_shotanswer');

        Route::get('/create/create_longanswer/{assignment_id}', 'BuildHomeworkController@create_longanswer')->name('homework.create_longanswer');
        Route::get('/create/create_longanswer/{assignment_id}/{question_id?}', 'BuildHomeworkController@edit_longanswer');
        Route::post('/save/create/longanswer', 'BuildHomeworkController@save_create_longanswer')->name('homework.teacher.create.longanswer');
        Route::post('/save/edit/longanswer', 'BuildHomeworkController@save_edit_longanswer')->name('homework.teacher.edit.longanswer');

        Route::get('/homework_tables', 'BuildHomeworkController@homework_tables')->name('homework.homework_tables');
        Route::post('/from_create/create_homework_topics', 'BuildHomeworkController@create_homework_topics');
        Route::post('/save/create/matching', 'BuildHomeworkController@savecreatematching')->name('homework.teacher.create.matching');
        Route::post('/save/edit/matching', 'BuildHomeworkController@saveeditmatching')->name('homework.teacher.edit.matching');
        Route::post('/save/create/shotanswer', 'BuildHomeworkController@savecreateshotanswer')->name('homework.teacher.create.shotanswer');
        Route::post('/save/edit/shotanswer', 'BuildHomeworkController@saveeditshotanswer')->name('homework.teacher.edit.shotanswer');
    });
      //end homework
    // test view email
    ...
    Route::post('/request/request_detail', 'RequestController@request_detail');
...
Route::group(['namespace'=>'frontend','middleware' => ['SessionTimeout']], function () {
    ...
    Route::group([ 'prefix' => 'members'], function () {
        ...
        //     return redirect('members/profile')->with('active', 'course');
        // });
        Route::get('/del_coures/{coures_id}', 'MemberController@del_coures');
    });
    ...
    Route::post('/upload/Up_quiz_file', 'CourseController@Up_quiz_file');
    Route::post('/get_data/Course_coursetFree', 'CourseController@search_coursetFree');
    Route::post('/get/Course_coursetFree', 'CourseController@search_coursetFree');
...
Route::group(['namespace'=>'backend', 'middleware' => ['admin'], 'prefix' => 'backend'], function () {
    ...
    Route::group([ 'prefix' => 'members'], function () {
        ...
        Route::post('serverside', 'MemberController@serverside')->name('members.serverside');
        ...
        Route::get('on_line/{id}', 'MemberController@on_line')->name('members.on_line');
    ...
    Route::group([ 'prefix' => 'users'], function () {
        ...
        Route::get('destroy/{users}', 'UserController@destroy')->name('users.destroy');
        Route::get('on_line/{id}', 'MemberController@on_line')->name('users.on_line');
    ...
    Route::group([ 'prefix' => 'classroom'], function () {
        ...
        Route::get('testprotest','ClassroomController@postTestCourse');
   ...
   Route::group([ 'prefix' => 'school'], function () {
        ...
        Route::post('update', 'SchoolController@updateschool')->name('school.update');
        // Route::get('importstudent', 'SchoolController@importstudent');
        Route::get('/edit/{school_id}', 'SchoolController@edit');
        Route::get('/student/{school_id}', 'SchoolController@student');
        Route::get('/teacher/{school_id}', 'SchoolController@teacher');
        Route::post('/student/create', 'SchoolController@createstudent')->name('school.student.create');
        Route::post('/student/update', 'SchoolController@updatestudent')->name('school.student.update');
        Route::post('/student/delete', 'SchoolController@deletestudent')->name('school.student.delete');
        Route::post('/teacher/create', 'SchoolController@createteacher')->name('school.teacher.create');
        Route::post('/teacher/update', 'SchoolController@updateteacher')->name('school.teacher.update');
        Route::post('/teacher/delete', 'SchoolController@deleteteacher')->name('school.teacher.delete');
        Route::get('/import/student', 'SchoolController@importstudent');
        Route::get('/import/teacher', 'SchoolController@importteacher');
        Route::post('/import/student/store', 'SchoolController@importstorestudent')->name('school.import.student.store');
        Route::post('/import/teacher/store', 'SchoolController@importstoreteacher')->name('school.import.teacher.store');
        Route::get('/donwload/student', 'SchoolController@donwloadimportstudent');
        Route::get('/donwload/teacher', 'SchoolController@donwloadimportteacher');
        Route::get('/updatedata/{id}', 'SchoolController@updatedata');

        Route::DELETE('destroyschool/{school_id}', 'SchoolController@destroyschool')->name('school.schooldestroy');
   });
