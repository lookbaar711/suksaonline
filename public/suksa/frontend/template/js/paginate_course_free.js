var course_free = {
  data: false,
   ...
   new_page : (data) => {
              ...
              <div class="col-sm-12 col-md-4 col-lg-3">
                  <div class="card mb-3">
                      <div class="product-grid">
                        ...
                        <ul class="social">
                          <li><a href="`+"/courses/"+value._id+`" data-tip="`+ detail +`"><i class="fa fa-search"></i></a></li>
                        </ul>
                      </div>
                      <div class="card-body text-center">
                          <a href="`+"/courses/"+value._id+`" class="p-b-5">
                              <p class="fs-18 text-black t-left"><b>Free</b></p>
                          </a>
                          <a href="`+"/courses/"+value._id+`" class="p-b-5">
     ...
     if(courses == ''){
       courses = '<h5 class="text-center bg-secondary text-white p-2 col-12">ไม่พบประวัติการสร้าง คอร์สเรียน</h5>';
     }
